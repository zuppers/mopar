 ...
 */
public class HBZip2OutputStream extends OutputStream implements BZip2Constants {
    ...
    */
    ...
    public HBZip2OutputStream(OutputStream inStream) throws IOException {
        this(inStream, 9);
    }

    public HBZip2OutputStream(OutputStream inStream, int inBlockSize)
            throws IOException {
        block = null;
        quadrant = null;
        zptr = null;
