 ...
 */
public class VariableModule implements LuaModule {

    /**
     * Constructs a new {@link VariableModule};
     */
     ...
     */
    public VariableConfig ForId(int id) {
        return VariableConfig.forId(id);
    }
     ...
     * @return the configuration.
     */
    public VariableConfig ForName(String name) {
        return VariableConfig.forName(name);
    }
